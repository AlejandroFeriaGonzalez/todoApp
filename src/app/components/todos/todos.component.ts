    ...
    <div class="min-h-screen w-full flex justify-center p-4 pt-20">
      <div class="w-full max-w-2xl animate-in fade-in zoom-in-95 duration-500">
        ...
        <header class="mb-8 text-center">
          <h1 class="text-5xl font-extrabold mb-2 bg-gradient-to-r from-purple-400 via-pink-400 to-orange-400 bg-clip-text text-transparent drop-shadow-sm">
        ...
        <div class="mb-8 relative group">
          <div class="absolute -inset-0.5 bg-gradient-to-r from-purple-500 to-pink-500 rounded-2xl opacity-50 group-focus-within:opacity-100 transition duration-300 blur-sm"></div>
          ...
          <div class="flex items-center bg-white/5 rounded-lg p-1 gap-1 backdrop-blur-sm border border-white/5">
            @for (filter of filters; track filter) {
              <button 
                ...
                class="px-4 py-1.5 rounded-md transition-all duration-200 capitalize"
